...
},{"./branch":1,"./branches-order":2,"./branches-paths":3,"./graph-rows":8,"./orientation":11,"./refs":12,"./template":14,"./user-api/gitgraph-user-api":16,"./utils":17}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class BranchUserApi {
    ...
    _getCommitStyle(style = {}) {
        ...
        if (this._graph.isHorizontal || this._graph.mode === mode_1.Mode.Compact) {
...
},{"../commit":5,"../mode":10,"../utils":17}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const commit_1 = require("../commit");
const branch_1 = require("../branch");
